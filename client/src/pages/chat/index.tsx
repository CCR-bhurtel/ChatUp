...
function Chat() {
  ...
  useEffect(() => {
    ...
    socket.on("newRoomCreated", (room: ISimpleRoom) => {
  ...
  return (
    <div className="chatContainer h-[90%] w-full flex lg:flex-row justify-start flex-col">
      ...
      <div className="w-full lg:max-w-[30%] flex-1 min-h-100 items-start overflow-y-scroll no-scrollbar">
      ...
      <div className="emptyChatArea hidden lg:flex lg:flex-1 lg:h-full items-center justify-center text-white text-center">
        Start Chatting now by clicking on the pencil <br /> icon or an existing
        group chat
      </div>
